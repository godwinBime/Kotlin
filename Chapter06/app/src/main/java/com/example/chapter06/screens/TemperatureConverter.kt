...
import com.example.chapter06.viewmodels.TemperatureViewModel
...
fun TemperatureConverter(viewModel: TemperatureViewModel) {
    ...
    Column(
        ...
        TemperatureScaleButtonGroup(selected = scale, modifier = Modifier.padding(bottom = 16.dp)){
                resId: Int ->
...
fun TemperatureTextField(
    ...
    TextField(value = temperature.value, onValueChange = {
